...
Feature: English text reaches the loaded definitions
  ...
  Scenario: the labels a player reads
    ...
    And A Certain Series: the ThingDef "ACS_AngelCore" is labelled "angel core"
    And A Certain Series: the ThingDef "ACS_DarkMatterBeetle" is labelled "white rhinoceros beetle"
    And A Certain Series: the PawnKindDef "ACS_DarkMatterBeetle" is labelled "white rhinoceros beetle"
    And A Certain Series: the ThingDef "ACS_Gabriel" is labelled "God's Power"
    And A Certain Series: the PawnKindDef "ACS_Gabriel" is labelled "God's Power"
