...
Feature: French text reaches the loaded definitions
  ...
  Scenario: the labels a player reads
    ...
    And A Certain Series: the ThingDef "ACS_AngelCore" is labelled "noyau angélique"
    And A Certain Series: the ThingDef "ACS_DarkMatterBeetle" is labelled "scarabée rhinocéros blanc"
    And A Certain Series: the PawnKindDef "ACS_DarkMatterBeetle" is labelled "scarabée rhinocéros blanc"
    And A Certain Series: the ThingDef "ACS_Gabriel" is labelled "Puissance de Dieu"
    And A Certain Series: the PawnKindDef "ACS_Gabriel" is labelled "Puissance de Dieu"
